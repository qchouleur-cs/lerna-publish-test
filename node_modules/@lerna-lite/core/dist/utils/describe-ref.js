 ...
 */
function describeRef(options = {}, includeMergedTags, gitDryRun = false) {
    const promise = (0, child_process_1.exec)('git', getArgs(options, includeMergedTags), options, gitDryRun);
 ...
 * @param {boolean} [includeMergedTags]
 */
function describeRefSync(options = {}, includeMergedTags, gitDryRun = false) {
    const stdout = (0, child_process_1.execSync)('git', getArgs(options, includeMergedTags), options, gitDryRun);
    const result = parse(stdout, options.cwd);
    if (options === null || options === void 0 ? void 0 : options.match) {
